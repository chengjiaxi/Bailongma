...
<div class="session-tabs" id="session-tabs">
  <div class="session-tab active" data-session="default">
    <span class="st-dot"></span>
    <span class="st-title">默认会话</span>
  </div>
  <button class="session-add" id="session-add" title="新建会话">+</button>
</div>
<aside id="panel-l1" class="panel">
  <header class="panel-identity">
    ...
    <div class="wake-indicator" id="wake-indicator" title="语音唤醒: 关闭">
      <span class="wake-dot"></span>
    </div>
    <button class="focus-btn" id="focus-btn" title="专注模式 (F11)" type="button">⊘</button>
    ...
    <div class="process-flow" id="process-flow">
      <div class="liquid-flow">
        <div class="liquid-track">
          <div class="liquid-fill" id="liquid-fill">
            <div class="liquid-wave"></div>
          </div>
        </div>
        <div class="liquid-node" data-stage="receive">
          <div class="liquid-card" id="card-receive">
            <div class="liquid-card-glow"></div>
            <div class="liquid-card-progress"></div>
            <div class="liquid-card-head">
              <span class="liquid-card-icon">📥</span>
              <span class="liquid-card-content">
                <span class="liquid-card-meta" id="meta-receive">接收消息</span>
              </span>
              <span class="liquid-card-arrow">›</span>
            </div>
            <div class="liquid-card-detail" id="detail-receive"></div>
          </div>
        </div>
        <div class="liquid-node" data-stage="think">
          <div class="liquid-card" id="card-think">
            <div class="liquid-card-glow"></div>
            <div class="liquid-card-progress"></div>
            <div class="liquid-card-head">
              <span class="liquid-card-icon">🧠</span>
              <span class="liquid-card-content">
                <span class="liquid-card-meta" id="meta-think">思考分析</span>
              </span>
              <span class="liquid-card-arrow">›</span>
            </div>
            <div class="liquid-card-detail" id="detail-think"></div>
          </div>
        </div>
        <div class="liquid-node" data-stage="tool">
          <div class="liquid-card" id="card-tool">
            <div class="liquid-card-glow"></div>
            <div class="liquid-card-progress"></div>
            <div class="liquid-card-head">
              <span class="liquid-card-icon">🔧</span>
              <span class="liquid-card-content">
                <span class="liquid-card-meta" id="meta-tool">工具调用</span>
              </span>
              <span class="liquid-card-arrow">›</span>
            </div>
            <div class="liquid-card-detail" id="detail-tool"></div>
          </div>
        </div>
        <div class="liquid-node" data-stage="respond">
          <div class="liquid-card" id="card-respond">
            <div class="liquid-card-glow"></div>
            <div class="liquid-card-progress"></div>
            <div class="liquid-card-head">
              <span class="liquid-card-icon">📤</span>
              <span class="liquid-card-content">
                <span class="liquid-card-meta" id="meta-respond">生成回复</span>
              </span>
              <span class="liquid-card-arrow">›</span>
            </div>
            <div class="liquid-card-detail" id="detail-respond"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="panel-actions">
    <button class="reflect-btn" id="reflect-btn" title="AI 自我反思">🪞</button>
...
<div class="node-modal-overlay" id="node-modal-overlay">
  <div class="node-modal" id="node-modal">
    <div class="node-modal-header">
      <span class="node-modal-type" id="nm-type"></span>
      <span class="node-modal-id" id="nm-id"></span>
      <button class="node-modal-close" id="nm-close">&times;</button>
    </div>
    <div class="node-modal-body">
      <div class="nm-section">
        <div class="nm-label">创建时间</div>
        <div class="nm-value" id="nm-time"></div>
      </div>
      <div class="nm-section">
        <div class="nm-label">内容</div>
        <div class="nm-value nm-content" id="nm-content"></div>
      </div>
      <div class="nm-section">
        <div class="nm-label">关联节点</div>
        <div class="nm-value" id="nm-relations"></div>
      </div>
      <div class="nm-section">
        <div class="nm-label">连接强度</div>
        <div class="nm-bar"><div class="nm-bar-fill" id="nm-strength"></div></div>
      </div>
    </div>
  </div>
</div>`;
